import { type APIApplicationCommandInteractionDataBasicOption, type APIApplicationCommandInteractionDataOption, type APIChatInputApplicationCommandDMInteraction, type APIChatInputApplicationCommandGuildInteraction, type APIChatInputApplicationCommandInteraction, ApplicationCommandOptionType, InteractionType } from "discord-api-types/payloads";
import { Discord } from "../..";
...
export class ChatCommandEvent<Options extends Record<string, ChatCommandBuilderOption> = {}, I extends APIChatInputApplicationCommandInteraction = APIChatInputApplicationCommandInteraction> extends CommandBaseEvent<I> {
    ...
    override inDM(): this is ChatCommandEvent<Options, APIChatInputApplicationCommandDMInteraction> {
